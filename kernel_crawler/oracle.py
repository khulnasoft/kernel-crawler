    ...
    def repos(self):
        ...
        for url in base_urls:
            for uek_version in possible_uek_versions:
                ...
                possible_uek_urls.append(
                    f"{url}/UEKR{uek_version}/latest/{self.arch}/"
                )  # Oracle 6 has one URL subpath for /latest
        ...
        for url in base_urls:
            ...
            possible_non_uek_urls.append(
                f"{url}/UEK/latest/{self.arch}/"
            )  # Oracle 6 has this non-versioned UEK subpath
